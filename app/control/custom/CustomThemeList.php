...
class CustomThemeList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        $this->form->addFields( [new TLabel(_t('Nome'))], [$name] );
        ...
        $this->form->addAction(_t('New'),  new TAction(array('CustomThemeForm', 'onEdit')), 'bs:plus-sign green');
