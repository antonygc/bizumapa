...
_p[14] = {
    value: function(require, exports, module) {
        ...
        function MinderRuntime() {
            ...
            minder.execCommand("text", "Tópico");
            // 导出给其它 Runtime 使用
            this.minder = minder;
        }
...
_p[15] = {
    value: function(require, exports, module) {
        function NodeRuntime() {
            ...
            var fsm = this.fsm;
            var main = hotbox.state("main");
            var buttons = [ "P/Cima:Alt+↑:ArrangeUp", "Inserir:Tab|Insert:AppendChildNode", "+Irmão:Enter:AppendSiblingNode", "P/Baixo:Alt+↓:ArrangeDown", "Remover:Delete|Backspace:RemoveNode", "+Pai:Shift+Tab|Shift+Insert:AppendParentNode" ];
            var AppendLock = 0;
                ...
                main.button({
                    ...
                    action: function() {
                        if (command.indexOf("Append") === 0) {
                            AppendLock++;
                            minder.execCommand(command, "Tópico");
...
angular.module('kityminderEditor').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('ui/directive/noteEditor/noteEditor.html',
    "<div class=\"panel panel-default\" ng-init=\"noteEditorOpen = false\" ng-show=\"noteEditorOpen\"><div class=\"panel-heading\"><h3 class=\"panel-title\">Nota</h3><i class=\"close-note-editor glyphicon glyphicon-remove\" ng-click=\"closeNoteEditor()\"></i></div><div class=\"panel-body\"><div ng-show=\"noteEnabled\" ui-codemirror=\"{ onLoad: codemirrorLoaded }\" ng-model=\"noteContent\" ui-codemirror-opts=\"{\n" +
    "                gfm: true,\n" +
    "                breaks: true,\n" +
    "                lineWrapping : true,\n" +
    "                mode: 'gfm',\n" +
  ...
  $templateCache.put('ui/dialog/hyperlink/hyperlink.tpl.html',
    "<div class=\"modal-header\"><h3 class=\"modal-title\">Inserir Link</h3></div><div class=\"modal-body\"><form><div class=\"form-group\" id=\"link-url-wrap\" ng-class=\"{true: 'has-success', false: 'has-error'}[urlPassed]\"><label for=\"link-url\">URL：</label><input type=\"text\" class=\"form-control\" ng-model=\"url\" ng-blur=\"urlPassed = R_URL.test(url)\" ng-focus=\"this.value = url\" ng-keydown=\"shortCut($event)\" id=\"link-url\" placeholder=\"http(s):// \"></div><div class=\"form-group\" ng-class=\"{'has-success' : titlePassed}\"><label for=\"link-title\">Texto：</label><input type=\"text\" class=\"form-control\" ng-model=\"title\" ng-blur=\"titlePassed = true\" id=\"link-title\" placeholder=\"Opcional: Texto ao passar o mouse sobre o link\"></div></form></div><div class=\"modal-footer\"><button class=\"btn btn-primary\" ng-click=\"ok()\">Salvar</button> <button class=\"btn btn-warning\" ng-click=\"cancel()\">Cancelar</button></div>"
  );
  ...
  $templateCache.put('ui/dialog/image/image.tpl.html',
    "<div class=\"modal-header\">    <h3 class=\"modal-title\">Inserir Imagem</h3></div><div class=\"modal-body\">    <form>        <div class=\"form-group\" ng-class=\"{true: 'has-success', false: 'has-error'}[urlPassed]\">            <label for=\"image-url\">URL：</label>            <input type=\"text\" class=\"form-control\" ng-model=\"data.url\" ng-blur=\"urlPassed = data.R_URL.test(data.url)\" ng-focus=\"this.value = data.url\" ng-keydown=\"shortCut($event)\" id=\"image-url\" placeholder=\"http(s):// \">        </div>        <div class=\"form-group\" ng-class=\"{'has-success' : titlePassed}\">            <label for=\"image-title\">Texto：</label>            <input type=\"text\" class=\"form-control\" ng-model=\"data.title\" ng-blur=\"titlePassed = true\" id=\"image-title\" placeholder=\"Opcional: texto ao passar o mouse sobre a imagem\">        </div>        <div class=\"form-group\">            <label for=\"image-preview\">Pré-Visualização：</label><img class=\"image-preview\" id=\"image-preview\" ng-src=\"{{ data.url }}\" alt=\"{{ data.title }}\"></div>    </form></div><div class=\"modal-footer\">    <button class=\"btn btn-primary\" ng-click=\"ok()\">Salvar</button>    <button class=\"btn btn-warning\" ng-click=\"cancel()\">Cancelar</button></div>"
  );
		...
		return {
			'zh-cn': {
				...
				'theme': {
					...
					'fresh-purple': 'Roxo +',
					'fresh-pink': 'Rosa +',
					'fresh-red-compat': 'Vermelho -',
					'fresh-soil-compat': 'Bonze -',
					'fresh-green-compat': 'Verde -',
					'fresh-blue-compat': 'Azul -',
					'fresh-purple-compat': 'Roxo -',
					'fresh-pink-compat': 'Rosa -',
					'tianpan':'Bola +',
					'tianpan-compact': 'Bola -'
				},
				...
				'ui': {
					...
					'command': {
						...
						'removenode': 'Remover',
						'editnode': 'Editar',
						'arrangeup': 'Mover para cima',
						'arrangedown': 'Mover para baixo',
						'resetlayout': 'Reorganizar',
						'expandtoleaf': 'Expandir',
						'expandtolevel1': 'Até o nível 1',
						'expandtolevel2': 'Até o nível 2',
						'expandtolevel3': 'Até o nível 3',
						'expandtolevel4': 'Até o nível 4',
						'expandtolevel5': 'Até o nível 5',
						'expandtolevel6': 'Até o nível 6',
						'fullscreen': '全屏',
						'outline': '大纲'
					},
					...
					'selectrevert': 'Inverter Seleção',
					'selectsiblings': 'Selecionar irmãos',
					'selectlevel': 'Selecionar no mesmo nível',
					'selectpath': 'Selecionar caminho',
					'selecttree': 'Selecionar filhos'
				},
				'popupcolor': {
					'clearColor': '清空颜色',
